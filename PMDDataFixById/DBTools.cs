...
namespace PMDDataFixById
{
    public class DBTools
    {
        ...
        public static readonly string Create_Log_sql = "CREATE TABLE up_sys_logs_pdm(id [numeric](10,0) not NULL,remark nvarchar(MAX) NULL,up_time datetime NULL,primary key (id)) ";
        public static readonly string Create_Config_sql = "CREATE TABLE up_sys_config_pdm(id varchar(50) NOT NULL,	bgtime datetime NULL,primary key (id)) ";
        ...
        public static bool checkLogTable() {
            ...
            {
                string sql = "select count(*) from up_sys_logs_pdm";
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = connection;
                cmd.CommandText = sql;
                try
        ...
        public static bool checkRecordUped(string pkid) {
            ...
            if (connection.State == ConnectionState.Open)
            {
                string sql = "select count(*) from up_sys_logs_pdm where id=" + pkid+"";
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = connection;
                cmd.CommandText = sql;
                try
        ...
        public static void WriteSysUpLog(List<JObject> list)
        {
            ...
            try
            {
                ...
                bulkCopy.DestinationTableName = "up_sys_logs_pdm";
        ...
        public static string GetSearchBgTime(string id) {
            ...
            SqlConnection connection = new SqlConnection(DBLink);
            connection.Open();
            string sql = "select top 1 bgtime from up_sys_config_pdm where id='" + id + "'";
            if (connection.State == ConnectionState.Open)
            {
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = connection;
        ...
        public static bool checkConfigTable()
        {
            ...
            if (connection.State == ConnectionState.Open)
            {
                string sql = "select * from up_sys_config_pdm";
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = connection;
                cmd.CommandText = sql;
                try
