...
namespace DBDataUpToServ
{
    public class DBTools
    {
        ...
        public static readonly string Create_Log_sql = "CREATE TABLE up_sys_logs(id [nvarchar](30) not NULL,remark nvarchar(max) NULL,up_time datetime NULL,primary key (id)) ";
